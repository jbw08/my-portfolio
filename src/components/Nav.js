...
const navigation = [
  ...
  { name: 'About Me', href: '../pages/About', current: false },
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'no-underline bg-gray-900 text-white' : 'no-underline text-gray-600 hover:bg-gray-700 hover:text-white',
